...
$contas = [
    ['id' => 1, 'conta' => 'Mercado de hoje', 'data' => '22/11/2024', 'valor' => '237,90'],
    ['id' => 2, 'conta' => 'Conta de Luz', 'data' => '25/11/2024', 'valor' => '130,50'],
    ['id' => 3, 'conta' => 'Internet Mensal', 'data' => '30/11/2024', 'valor' => '89,90'],
    ['id' => 4, 'conta' => 'Manutenção Carro', 'data' => '10/12/2024', 'valor' => '450,00'],
    ['id' => 5, 'conta' => 'Escola das Crianças', 'data' => '15/12/2024', 'valor' => '1.200,00']
];
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        ...
        <div class="mt-3 text-center">
            <a href="addConta.php" class="btn btn-success">Adicionar Nova Conta</a>
        </div>
            ...
            <table class="table text-white table-bg">
                ...
                <tbody>
                    ...
                    foreach ($contas as $conta) {
                        ...
                        echo "<td>
                            <a class='btn btn-sm btn-primary' href='editConta.php?id=" . $conta['id'] . "'>Editar</a>
                            <a class='btn btn-sm btn-danger' href='deleteConta.php?id=" . $conta['id'] . "'>Deletar</a>
                        </td>";
                        echo "</tr>";
                    }
                    ?>
