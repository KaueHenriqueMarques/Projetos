...
// Simulação de valores por mês
$cartao = [
    ['id' => 1, 'mes' => '09', 'valor' => '1.900,00'],
    ['id' => 2, 'mes' => '10', 'valor' => '2.100,00'],
    ['id' => 3, 'mes' => '11', 'valor' => '1.800,00'],
    ['id' => 4, 'mes' => '12', 'valor' => '2.000,00']
];
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        ...
        <div class="box-search">
            <input type="search" class="form-control" placeholder="Pesquisar Mês">
        ...
        <div class="mt-3 text-center">
            <a href="addMes.php" class="btn btn-success">Adicionar Novo Mês</a>
        </div>
        ...
        <div class="m-5">
            <table class="table text-white table-bg">
                ...
                <tbody>
                    <?php
                    foreach ($cartao as $mes) {
                        echo "<tr>";
                        echo "<td>" . $mes['id'] . "</td>";
                        echo "<td>" . htmlspecialchars($mes['mes'], ENT_QUOTES, 'UTF-8') . "</td>";
                        echo "<td>R$ " . htmlspecialchars($mes['valor'], ENT_QUOTES, 'UTF-8') . "</td>";
                        echo "<td>
                            <a class='btn btn-sm btn-primary' href='editMes.php?id=" . $mes['id'] . "'>Editar</a>
                            <a class='btn btn-sm btn-danger' href='deleteMes.php?id=" . $mes['id'] . "'>Deletar</a>
                        </td>";
                        echo "</tr>";
                    }
                    ?>
