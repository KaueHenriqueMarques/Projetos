...
// Simulação de fechamento do mês
$fechamentoMes = [
    ['id' => 1, 'mes' => '11/2024', 'total' => '125.000,00'],
    ['id' => 2, 'mes' => '10/2024', 'total' => '120.000,00'],
    ['id' => 3, 'mes' => '09/2024', 'total' => '118.000,00']
];
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        ...
        <div class="mt-3 text-center">
            <a href="addFechamentoMes.php" class="btn btn-success">Adicionar Novo Fechamento</a>
        </div>

        <!-- Tabela de Fechamento do Mês -->
        <div class="m-5">
            <table class="table text-white table-bg">
                ...
                <tbody>
                    <?php
                    foreach ($fechamentoMes as $fechamento) {
                        echo "<tr>";
                        echo "<td>" . $fechamento['id'] . "</td>";
                        echo "<td>" . htmlspecialchars($fechamento['mes'], ENT_QUOTES, 'UTF-8') . "</td>";
                        echo "<td>R$ " . htmlspecialchars($fechamento['total'], ENT_QUOTES, 'UTF-8') . "</td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
