...
// Simulação de fechamento do dia
$fechamentoDia = [
    ['id' => 1, 'data' => '22/11/2024', 'total' => '5.000,00'],
    ['id' => 2, 'data' => '21/11/2024', 'total' => '4.500,00'],
    ['id' => 3, 'data' => '20/11/2024', 'total' => '4.200,00']
];
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        ...
        <div class="box-search">
            <input type="search" class="form-control" placeholder="Pesquisar Data">
        ...
        <div class="mt-3 text-center">
            <a href="addFechamentoDia.php" class="btn btn-success">Adicionar Novo Fechamento</a>
        </div>

        <!-- Tabela de Fechamento do Dia -->
        <div class="m-5">
            <table class="table text-white table-bg">
                ...
                <tbody>
                    <?php
                    foreach ($fechamentoDia as $fechamento) {
                        echo "<tr>";
                        echo "<td>" . $fechamento['id'] . "</td>";
                        echo "<td>" . htmlspecialchars($fechamento['data'], ENT_QUOTES, 'UTF-8') . "</td>";
